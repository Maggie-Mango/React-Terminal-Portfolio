    ...
    <Intro
       ...
       <div style={styles.soundtok}>
        <div>
          ...
          <p>The Modal relied on React Hooks UseState and UseEffect. I made sure the modal could deeply nested objects from the API. The modal had the ability to accept 5 photos, has error handling, sliders, buttons, star ratings and multiple choice questions. There is also a ratings system which auto-calculates the meean of user ratings in real-time.</p>
