  ...
  return (
    ...
    <div className="padding">
      ...
      <div>
        ...
        <h1>Introduction</h1>
          <p>Growing up I was a naturally curious kid who always pestered adults with philosophical questions on how the world worked. My late teens and most of my 20s were marked with books and travels around Latin America and Asia, where I sought to surround myself with perspectives unlike my own. While my experiences weren't always comfortable, I thrived being in environments where I was constantly learning something new.</p>
          <p>Fast-forward to 2020 where my life, as did the rest of the world, came to a screeching halt. Until then, I was always on the move trying to hustle to my next destination. As days turned into weeks and weeks turned into months, the idea of seriously learning how to program entered my head. Before then, I had fruitlessly tried to teach myself Ruby, Python and web development on my own. My first tech role intro'd me to SQL but also shook my confidence since I felt like an imposter surrounded by tech geniuses (it wasn't until I started a new position in a different company that I realized I actually had a good grasp of advanced syntax). Contributing to my insecurities, I was the first in my immediate family to finish higher education and also the first to have a white collar career. Becoming an Engineer felt like it was <i>too</i> out of my realm.</p>
          ...
          <p>I also want to pay it forward and to teach others who think this topic is too far out of reach for them</p>
      </div>
    </div>
    </>
  );
